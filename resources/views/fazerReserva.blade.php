...
@csrf
  ...
  <div class="col-md-3">
    ...
    <input type="number" class="form-control" id="inputCodigoCliente" name="nome">
  </div>
  ...
  <div class="col-md-3">
    ...
    <input type="text" class="form-control" id="inputValor" name="valorDiaria">
  </div>

  <div class="col-md-3">
    <label for="inputValor4" class="form-label">Data Entrada: </label>
    <input type="date" class="form-control" id="inputValor" name="dataEntrada">
  </div>

  <div class="col-md-3">
    <label for="inputValor4" class="form-label">Data Saida: </label>
    <input type="date" class="form-control" id="inputValor" name="DataSaida">
  </div>
